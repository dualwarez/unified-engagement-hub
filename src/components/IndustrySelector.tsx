...
import { Building2, TrendingUp, GraduationCap, Shield, DollarSign, Home, CheckCircle, Sparkles, ArrowRight, Phone, MessageSquare, Brain, BarChart3, Users, Bot, Calendar } from 'lucide-react';
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <TabsContent value="industries" className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {industries.map(industry => <Card key={industry.name} className="group hover:shadow-xl transition-all duration-300 cursor-pointer border-2 hover:border-blue-200" onClick={() => onSelect(industry.name)}>
                  <CardHeader>
